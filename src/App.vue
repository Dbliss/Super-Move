...
const houseTypes = [
  ...
  },
  {
    ...
    defaults: {
      ...
      bathroomMirror: 3,
      boxSmallBathroom: 2,
      boxMediumBathroom: 13,
      bench: 1,
      bookcaseClosedGarage: 2,
      boxSmallGarage: 7,
      boxMediumGarage: 7,
      pottedPlantLiving: 16,
    },
  },
];
...
const estimatedRoomVolume = computed(() => {
  ...
  if (isStudioSelected.value) return base;
...
const quoteVolumeM3 = computed(() => {
  const capacity = packedTruckCapacity.value;
  if (!capacity) return estimatedRoomVolume.value || totalVolume.value;
  return capacity * (fillPercent.value / 100);
});
...
const buildQuoteSubmissionPayload = () => {
  ...
  return {
    ...
    move: {
      ...
      totalVolumeM3: Number(quoteVolumeM3.value.toFixed(2)),
        ...
        <div class="qs-details">
          ...
          <div class="qs-rows">
            ...
            <div class="qs-row">
              ...
              <strong>~{{ Math.round(quoteVolumeM3) }} m³</strong>
            </div>
            <div class="qs-row">
